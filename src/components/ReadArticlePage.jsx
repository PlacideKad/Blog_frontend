  ...
  return(
    <div className="flex flex-col items-center justify-start min-h-[50vh] w-full space-y-4">
      ...
      <img className=" w-full [aspect-ratio:30/12]" style={{
        objectFit:'cover'
      }} src={article.cover&& article.cover.link} alt="article cover" />
      ...
      <section className="w-full mt-2 p-1 border-t-2 border-fuchsia-400">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="w-fit flex items-center">
            ...
            <div onClick={()=>{setIsLiked(prev=>!prev)}} className="cursor-pointer h-full grid content-center">
      ...
      <section className="w-full px-2">
        <form action={handleNewComment} className="flex flex-col items-center space-y-2">
          ...
          <button className={`px-4 py-2 bg-linear-to-r from-fuchsia-400 to-purple-500 text-white rounded-lg  ${isPressed?'scale-97':'shadow-md shadow-neutral-700'} transition-all ease duration-200 flex items-center space-x-1`}
